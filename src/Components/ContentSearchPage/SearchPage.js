...
import MyResultTemplateFunction from "../../config/ContentResultTemplate";
  ...
  return (
    <>
      ...
      <SearchInterfaceContainer>
        <AtomicSearchWrapper style={{backgroundColor: "#F6F1EB !important"}}>
      ...
      {EnableDebugMode && <RelevanceInspector/>}
          <RedirectionTrigger />
          <NotifyTrigger />
          <atomic-search-layout style={{backgroundColor: "#F6F1EB !important"}}>
            <style>{CustomAtomicStyle}</style>
            <atomic-layout-section section="facets" style={{backgroundColor: "#F6F1EB !important"}}>
